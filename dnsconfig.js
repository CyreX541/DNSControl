...
D("cxsrv.de", REGISTRAR, MAIL01,
  ...
  // FSN1-DC14 - Mail
  A("mail", "49.12.213.26"), AAAA("mail", "2a01:4f8:1c17:c55a::1"),
...
D("rsmg-clan.de", REGISTRAR, MAIL01,
  ...
  // CNAME - GAMES
  CNAME("amongus", "games.cxsrv.de."), CNAME("gta", "games.cxsrv.de."),
  CNAME("mc", "games.cxsrv.de."),

  // CNAME - VOICE
  CNAME("crewlink", "voice.cxsrv.de."), CNAME("music", "voice.cxsrv.de."),
